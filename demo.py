...
def main(is_test: bool = False):
    ...
    from qai_hub_models.models.controlnet.model import ControlNetDecoder
    controlnet_decoder = ControlNetDecoder.from_precompiled()
    ...
    controlnet_decoder = _get_on_device_model(
        controlnet_decoder, "controlnet_decoder", args.ignore_cached_model, args.device_name
    )
    ...
    app = ControlNetApp(
        ...
        controlnet=controlnet_decoder,  # type: ignore[arg-type]
        tokenizer=tokenizer,
        scheduler=scheduler,
